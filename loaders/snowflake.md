...
Alternative options are [`datamill-co`](./snowflake--datamill-co.html) and [`meltano`](./snowflake--meltano.html).
...
1. Add the `target-snowflake` loader to your project using [`meltano add`](https://docs.meltano.com/command-line-interface.html#add):
...
- Name: `dbname`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_DBNAME`, alias: `SF_DATABASE`
...
- Name: `user`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_USER`, alias: `SF_USER`
...
- Name: `password`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_PASSWORD`, alias: `SF_PASSWORD`
...
- Name: `s3_bucket`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_S3_BUCKET`
...
- Name: `stage`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_STAGE`
...
- Name: `file_format`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_FILE_FORMAT`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_DEFAULT_TARGET_SCHEMA`, alias: `TARGET_SNOWFLAKE_SCHEMA`, `SF_SCHEMA`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_AWS_ACCESS_KEY_ID`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_AWS_SECRET_ACCESS_KEY`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_AWS_SESSION_TOKEN`
...
- Name: `aws_profile`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_AWS_PROFILE`
...
- Name: `s3_key_prefix`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_S3_KEY_PREFIX`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_S3_ENDPOINT_URL`
...
- Name: `s3_region_name`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_S3_REGION_NAME`
...
- Name: `s3_acl`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_S3_ACL`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_BATCH_SIZE_ROWS`
- Default: `100000`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_FLUSH_ALL_STREAMS`
- Default: `false`
...
- Name: `parallelism`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_PARALLELISM`
- Default: `0`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_PARALLELISM_MAX`
- Default: `16`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_DEFAULT_TARGET_SCHEMA_SELECT_PERMISSION`
...
- Name: `schema_mapping`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_SCHEMA_MAPPING`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_DISABLE_TABLE_CACHE`
- Default: `false`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_CLIENT_SIDE_ENCRYPTION_MASTER_KEY`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_CLIENT_SIDE_ENCRYPTION_STAGE_OBJECT`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_ADD_METADATA_COLUMNS`
- Default: `false`
...
- Name: `hard_delete`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_HARD_DELETE`
- Default: `false`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_DATA_FLATTENING_MAX_LEVEL`
- Default: `0`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_PRIMARY_KEY_REQUIRED`
- Default: `true`
...
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_VALIDATE_RECORDS`
- Default: `false`
...
- Name: `temp_dir`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_TEMP_DIR`
...
- Name: `no_compression`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_NO_COMPRESSION`
- Default: `false`
...
- Name: `query_tag`
- [Environment variable](https://docs.meltano.com/configuration.html#configuring-settings): `TARGET_SNOWFLAKE_QUERY_TAG`
