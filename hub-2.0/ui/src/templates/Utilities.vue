      ...
      <div class="single-plugin-detail">
        ...
        <div class="single-plugin-main">
          ...
          <p>
            ...
            <a href="https://docs.meltano.com/concepts/plugins#utilities"
              >utility</a
            >
          ...
          <div>
            ...
            ><code>{{ $page.utilities.name }}</code></pre>
          ...
          <ul>
            <li
              v-for="(capability, index) in $page.utilities.capabilities"
              v-bind:key="index"
            >
              {{ capability }}
            </li>
          ...
          <h2>Settings</h2>
          <p>
            {{ $page.utilities.name }} requires the configuration of the
            following settings:
          </p>
          <ul>
            <li
              v-for="(setting, index) in $page.utilities.settings"
              v-bind:key="index"
            >
              {{ setting.name }}
            </li>
