      ...
      <div class="single-plugin-detail">
        ...
        <div class="single-plugin-main">
          ...
          <p>
            ...
            <a href="https://docs.meltano.com/concepts/plugins#extractors"
              >Meltano extractor</a
            >
            pulls data from
            <a href="https://docs.github.com/en/rest">GitHub</a> that can then
            be sent to a destination using a
            <g-link to="/loaders">loader</g-link>.
          </p>
          ...
          <ol>
            <li>
              Add the {{ $page.extractors.name }} extractor to your project
              using
          ...
          <div>
            ...
            ><code>{{ $page.extractors.name }}</code></pre>
          ...
          <ul>
            <li
              v-for="(capability, index) in $page.extractors.capabilities"
              v-bind:key="index"
            >
              {{ capability }}
            </li>
          ...
          <h2>Settings</h2>
          <p>
            {{ $page.extractors.name }} requires the configuration of the
            following settings:
          </p>
          <ul>
            <li
              v-for="(setting, index) in $page.extractors.settings"
              v-bind:key="index"
            >
              {{ setting.name }}
            </li>
