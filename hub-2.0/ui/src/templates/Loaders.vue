    ...
    <div class="single-plugin-overview">
      <div class="single-plugin-detail">
        ...
        <div class="single-plugin-main">
          ...
          when originally added to the Hub. Please review the capabilities when using this extractor. If you find they are out of date, please consider updating them by making a pull request to the YAML file that defines the capabilities for this extractor.</p>
