...
replication-method	All	Either FULL_TABLE, INCREMENTAL, or LOG_BASED. The replication method to use for a stream.
See Data Integration for more details on the replication type.
...
Keyword	Tap Type	Description
inclusion	All	Either available, automatic, or unsupported.
