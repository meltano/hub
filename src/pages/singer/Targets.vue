<template>
  <Layout>
    <div class="plugins-overview">
      <h1>Singer Targets</h1>
      <p>
        <a href="https://www.singer.io/">Singer</a> taps and targets can be used together to pull data from <g-link to="/singer/taps">any source</g-link> and send it to any <g-link to="/singer/targets">destination</g-link>. All targets listed here can be used standalone, or as <g-link to="/loaders">loaders</g-link> in <a href="https://www.meltano.com">Meltano</a>.
      </p>
