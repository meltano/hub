          ...
          <div class="footer-table ml-margins">
            <div class="footer-col footer-main-col">
              <div class="footer-col-info">
                <a href="https://meltano.com/">
                  <svg class="footer-logo" xmlns="http://www.w3.org/2000/svg" width="180" height="42" viewBox="0 0 180 42" fill="none">
                    <path
                ...
                <div class="newsletter-mini-box">
                  ...
                  <svg class="newsletter-min-box-glow" xmlns="http://www.w3.org/2000/svg" width="123" height="2" viewBox="0 0 123 2" fill="none">
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_2123_20269" x1="123" y1="1.5" x2="-3.46493e-08" y2="1.49999" gradientUnits="userSpaceOnUse">
            ...
            <div class="footer-col">
              <div class="footer-col-info">
                ...
                <ul>
                  <li>
                    <svg class="footer-list-icon" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                      <rect class="footer-icon-frame" width="36" height="36" rx="18" fill="white" fill-opacity="0.1" />
                      <g>
                        <path
                    ...
                    <a href="https://meltano.com/overview/">
                      ...
                      <p class="footer-list-info">CLI & version control for ELT without limitations</p>
                    </a>
                  </li>
                  <li>
                    <svg class="footer-list-icon" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                  ...
                  <li>
                    <svg class="footer-list-icon" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                      <rect class="footer-icon-frame" width="36" height="36" rx="18" fill="white" fill-opacity="0.1" />
                      <g>
                        <path d="M25.9167 22.8072V13.6024L17.9586 9L10 13.6024V22.8072L17.9586 27.4096L25.9167 22.8072Z" fill="#B5B4BA" />
                      </g>
                    </svg>
                    <a href="https://sdk.meltano.com/en/latest/">
                      <p class="footer-list-title">Meltano/SDK</p>
                      <p class="footer-list-info">The fastest way to build custom data extractors and loaders</p>
                    </a>
                  </li>
                  <li>
                    <svg class="footer-list-icon" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                ...
                <ul>
                  <li>
                    ...
                    <a href="https://meltano.com/community/">
                      ...
                      <p class="footer-list-info">Meltano is an open-source project with a thriving community of data professionals.</p>
                    </a>
                  </li>
                  <li>
                    <svg class="footer-list-icon" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                    ...
                    <a href="https://docs.meltano.com/">
                      ...
                      <p class="footer-list-info">Here you'll learn how to use Meltano, how Meltano is built, and where to get started</p>
                    </a>
                  </li>
                  <li>
                    <svg class="footer-list-icon" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                  ...
                  <li>
                    ...
                    <a href="https://meltano.com/partners/">
                      ...
                      <p class="footer-list-info">Our trusted consulting partners help you take Meltano and Singer into production</p>
                    </a>
                  </li>
                </ul>
              </div>
                ...
                <ul>
                  <li>
                    ...
                    <a href="https://meltano.com/about/">
                      ...
                      <p class="footer-list-info">We love data, software development best practices, and dragons!</p>
                    </a>
                  </li>
                  <li>
                    <svg class="footer-list-icon" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                    ...
                    <a href="https://meltano.com/press/">
                      ...
                      <p class="footer-list-info">Meltano related news, press releases, our media kit (logos), and how to get in touch</p>
                    </a>
                  </li>
                  <li>
                    <svg class="footer-list-icon" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                      <rect class="footer-icon-frame" width="36" height="36" rx="18" fill="white" fill-opacity="0.1" />
                      <g>
                        <path d="M18 18C20.2091 18 22 16.2091 22 14C22 11.7909 20.2091 10 18 10C15.7909 10 14 11.7909 14 14C14 16.2091 15.7909 18 18 18Z" fill="#B5B4BA" />
                        <path
                  ...
                  <li>
                    ...
                    <a href="https://meltano.com/contact/">
                      ...
                      <p class="footer-list-info">The Meltano team is here to help. Ask us anything, or give us your feedback!</p>
                    </a>
                  </li>
                </ul>
              </div>
        ...
        <div class="footer-container">
          <div class="footer-bar ml-margins">
            ...
            <div class="footer-social">
              ...
              <a href="https://meltano.slack.com/join/shared_invite/zt-1nyq6h1ba-OUD5lCP2lrB9mAmuKnTSmw#/shared-invite/email" target="_blank">
              ...
              <a href="https://www.linkedin.com/company/meltano/?original_referer=https%3A%2F%2Fmeltano.com%2F" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 24 23" fill="none">
                  <path
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 24 23" fill="none">
                  ...
                  <defs>
                    <clipPath id="clip0_1613_31350">
                      <rect width="22.9834" height="22.9834" fill="white" transform="translate(0.585938)" />
                    </clipPath>
                  </defs>
                </svg>
              </a>
