...
- **Maintenance status**: Unresponsive to community issues and contributions
  - A [more active fork](https://github.com/singer-io/tap-bing-ads/network) may be available that you can [use instead](https://meltano.com/docs/plugin-management.html#using-a-custom-fork-of-a-plugin).
...
1. Add the `tap-bing-ads` extractor to your project using [`meltano add`](https://meltano.com/docs/command-line-interface.html#add):
...
`tap-bing-ads` requires the [configuration](https://meltano.com/docs/configuration.html) of the following settings:
...
A minimal configuration of `tap-bing-ads` in your [`meltano.yml` project file](https://meltano.com/docs/project.html#meltano-yml-project-file) will look like this:
...
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `OAUTH_BING_ADS_DEVELOPER_TOKEN`
...
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `OAUTH_BING_ADS_CLIENT_ID`
...
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `OAUTH_BING_ADS_CLIENT_SECRET`
...
- Name: `customer_id`
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `TAP_BING_ADS_CUSTOMER_ID`
...
- Name: `account_ids`
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `TAP_BING_ADS_ACCOUNT_IDS`
...
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `TAP_BING_REQUIRE_LIVE_CONNECT`
- Default: 'True'
...
- Name: `start_date`
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `TAP_BING_ADS_START_DATE`
