...
1. Add the `tap-facebook` extractor to your project using [`meltano add`](https://meltano.com/docs/command-line-interface.html#add):
...
`tap-facebook` requires the [configuration](https://meltano.com/docs/configuration.html) of the following settings:
...
A minimal configuration of `tap-facebook` in your [`meltano.yml` project file](https://meltano.com/docs/project.html#meltano-yml-project-file) will look like this:
...
- Name: `account_id`
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `TAP_FACEBOOK_ACCOUNT_ID`
...
- Name: `access_token`
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `TAP_FACEBOOK_ACCESS_TOKEN`
...
- Name: `start_date`
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `TAP_FACEBOOK_START_DATE`
...
- Name: `end_date`
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `TAP_FACEBOOK_END_DATE`
...
- [Environment variable](https://meltano.com/docs/configuration.html#configuring-settings): `TAP_FACEBOOK_INSIGHTS_BUFFER_DAYS`
- Default: `0`
